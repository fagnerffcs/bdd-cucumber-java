...
public class LoginSteps {
    ...
    public void é_direcionado_para_a_pagina_de_leiloes() {
    ...
    public void tenta_se_logar() {
        leiloesPage = this.loginPage.realizaLoginComo("cicrano", "pass");
    }

    @Entao("continua na pagina de login")
    public void continua_na_pagina_de_login() {
        Assert.assertTrue(leiloesPage.estaNaPaginaDeLogin());
    }
